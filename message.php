...
if ($errCode == 0) {
    if($msg->Event=='subscribe'){
        ...
        $respondMsg =  '<xml><ToUserName><![CDATA['.$toUser.']]></ToUserName><FromUserName><![CDATA['.$fromUser.']]></FromUserName><CreateTime>'.time().'</CreateTime><MsgType><![CDATA[text]]></MsgType><Content><![CDATA[欢迎关注我们]]></Content></xml>';
        echo $respondMsg;
        exit();
    }
    ...
    error_log("解密失败：".$errCode, 3, "log.txt");
}
class WXBizMsgCrypt
{
    private $token;
